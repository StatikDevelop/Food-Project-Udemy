...
function cards() {
  var card = document.querySelectorAll('.menu__item');

  var Card = /*#__PURE__*/function () {
    function Card(src, imgAlt, title, descr, price) {
    ...
    _createClass(Card, [{
      key: "priceConverterToUAH",
      value: function priceConverterToUAH() {
        this.price = this.price * this.transfer;
      }
    }, {
      key: "render",
      value: function render() {
        var wrapper = document.querySelector('[data-cardContainer]');
  ...
  var getResourses = /*#__PURE__*/function () {
    ...
    return function getResourses(_x) {
...
function form(_ref) {
  var formSelector = _ref.formSelector,
      ...
      modalWindowTimer = _ref.modalWindowTimer;
  //Forms
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      ...
      var json = JSON.stringify(Object.fromEntries(formData.entries())); // request.send(JSON.stringify(object));
  ...
  function showThanksModal(message) {
    ...
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_8__.openModal)(modalSelector, modalWindowTimer);
    ...
    setTimeout(function () {
      ...
      (0,_modules_modal__WEBPACK_IMPORTED_MODULE_8__.closeModal)(modalSelector);
    }, 4000);
  ...
  fetch('http://localhost:3000/menu').then(function (item) {
    return item.json();
  }).then(function (item) {
...
function modal(_ref) {
  var modalSelector = _ref.modalSelector,
      ...
      modalWindowTimer = _ref.modalWindowTimer;
  // Modal
  var modalTrigger = document.querySelectorAll(openTrigger),
      modal = document.querySelector(modalSelector);
  modalTrigger.forEach(function (item) {
    item.addEventListener('click', function () {
      return openModal(modalSelector, modalWindowTimer);
    });
  });
...
function slider(_ref) {
  ...
  var currentItem = document.querySelector(currentCounter);
  var totalItem = document.querySelector(totalCounter);
  var sliderIndex = 1;
  var offset = 0;

  if (slides.length < 10) {
    totalItem.textContent = "0".concat(slides.length);
    currentItem.textContent = "0".concat(sliderIndex);
  } else {
...
__webpack_require__.r(__webpack_exports__);
function timer(_ref) {
  var timerSelector = _ref.timerSelector,
...
window.addEventListener('DOMContentLoaded', function () {
  var modalWindowTimer = setTimeout(function () {
    return (0,_js_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)('.modal', modalWindowTimer);
  }, 60000);
  (0,_js_modules_calc__WEBPACK_IMPORTED_MODULE_0__.default)();
  (0,_js_modules_cards__WEBPACK_IMPORTED_MODULE_1__.default)();
  (0,_js_modules_form__WEBPACK_IMPORTED_MODULE_2__.default)({
    formSelector: 'form',
    modalSelector: '.modal',
    modalWindowTimer: modalWindowTimer
  });
  (0,_js_modules_modal__WEBPACK_IMPORTED_MODULE_3__.default)({
    modalSelector: '.modal',
...
/*!******************************************************!*\
  ...
  \******************************************************/
/*! unknown exports (runtime-defined) */
/*! runtime requirements: __webpack_exports__, top-level-this-exports, __webpack_require__.g, __webpack_require__, module, __webpack_require__.* */
/*! CommonJS bailout: this is used directly at 346:119-123 */
/*! CommonJS bailout: exports is used directly at 29:38-45 */
